export function GearCardSkeleton() {
  return (
    <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden animate-pulse flex flex-col h-full">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 animate-pulse">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="h-[480px] bg-white border border-slate-200 rounded-3xl p-6" />
      </div>
    </div>
  );
}
