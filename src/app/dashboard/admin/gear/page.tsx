  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-extrabold text-white">Content Moderation — Gear</h1>
          <p className="text-xs text-slate-400">All gear listings across providers</p>
        </div>
      </div>
            ...
            <tbody className="divide-y divide-slate-800">
              {gear.map((g) => (
                <tr key={g.id} className="bg-slate-900/40 hover:bg-slate-900/70 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="text-slate-200">{g.provider?.name || "—"}</div>
